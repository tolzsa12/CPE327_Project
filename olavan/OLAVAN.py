...
#t5 = [0, 11.7 14.9 17.3 18.6 19.5 21.1 23.5 24.3 26.7 29.1 30.2 31.6 33.5 36.0 38.4 39.7 40.9 43.4 45.8 48.3 50.8 53.7 54.8 56.9 58.3 60.6 63.2 65.7 70.9 73.6 75.6 83.0 85.4 87.9 90.4] #bootybomb
...
b5 = ["n", c, c, c, d, c, d, c, d, d, c, c, d, c, d, d, c, d, c, c, d, d, c, d, c, d, d, c, d, c, d, c, c, d, d, c] # booty bomb
...
tempT = [t0, t1, t2, t3, t4, t6, t7]
tempB = [b0, b1, b2, b3, b4, b6, b7]
listSong = ["Jingle Bell", "Shutdown", "Too Cute", "Antifragile", "Tokyo Drift", "Oh Ka", "Fire Boy"] #เวลาจะเพิ่มหรือลด มาแก้ตรงนี้พอ เวลาตั้งชื่อไฟล์ให้ตั้งด้วยชื่อเพลงนี้ ตามด้วย_ 
