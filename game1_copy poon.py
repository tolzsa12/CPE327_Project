...
def confirmMusicPage(stateMusic):
    ...
    soundName = list_song[stateMusic]
    if stateMusic == 0:
        mixer.music.load(confirmPagePath+"/JingleBell.mp3")
        mixer.music.play()
        
    elif stateMusic == 1:
        mixer.music.load(confirmPagePath+"/Shutdown.mp3")
        mixer.music.play()

    elif stateMusic == 2:
        mixer.music.load(confirmPagePath+"/Kein Tan.mp3")
        mixer.music.play()
